...
public class FSharpSensorTest {
  ...
  private FsSonarRunnerExtractor extractor;
  ...
  public void shouldExecuteOnProject() {
    ...
    FSharpSensor sensor =
      new FSharpSensor(
        mock(Settings.class), mock(FsSonarRunnerExtractor.class),
        fs,
    ...
    fs.add(new DefaultInputFile("bar").setAbsolutePath("bar").setLanguage("fs"));
  ...
  //@Test
  public void issue() {
    verify(issueBuilder).ruleKey(RuleKey.of(FSharpPlugin.REPOSITORY_KEY, "S1186"));
